...
const privacy = () => (
    <section id="privacy" className="">
        ...
        <main className="container mx-auto text-section p-8">
            ...
            <p>
                SportySpots built the SportySpots app as a Free app. This
                SERVICE is provided by SportySpots at no cost and is intended
                ...
                Terms and Conditions, which is accessible at SportySpots unless
