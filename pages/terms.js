...
const terms = () => (
  <section className="">
    ...
    <main className="container mx-auto text-section p-8">
      ...
      <p>Please read these Terms and Conditions carefully before using our SportySpots mobile
      ...
      <p>The Service and its original content (excluding Content provided by users), features and
        functionality are and will remain the exclusive property of SportySpots and its licensors.
      ...
      <p>Our Service may contain links to third-party web sites or services that are not owned or
        controlled by SportySpots.</p>

      <p>SportySpots has no control over, and assumes no responsibility for, the content, privacy
        policies, or practices of any third party web sites or services. You further acknowledge and
        agree that SportySpots shall not be responsible or liable, directly or indirectly, for any
        damage or loss caused or alleged to be caused by or in connection with use of or reliance on
        any such content, goods or services available on or through any such web sites or
        services.</p>
      ...
      <p>In no event shall SportySpots, nor its directors, employees, partners, agents, suppliers,
      ...
      <p>SportySpots its subsidiaries, affiliates, and its licensors do not warrant that a) the
