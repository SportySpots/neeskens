    ...
    <section className="">
        ...
        <main className="container mx-auto text-section p-8">
            ...
            <p>
                ...
                govern your relationship with SportySpots mobile application
                (the "Service") operated by SportySpots ("us", "we", or "our").
            </p>

            <p>
                Please read these Terms and Conditions carefully before using
                our SportySpots mobile application (the "Service").
            </p>
            ...
            <p>
                ...
                exclusive property of SportySpots and its licensors. The Service
                ...
                without the prior written consent of SportySpots.
            </p>
            ...
            <p>
                ...
                services that are not owned or controlled by SportySpots.
            </p>

            <p>
                SportySpots has no control over, and assumes no responsibility
                for, the content, privacy policies, or practices of any third
                party web sites or services. You further acknowledge and agree
                that SportySpots shall not be responsible or liable, directly or
            ...
            <p>
                In no event shall SportySpots, nor its directors, employees,
            ...
            <p>
                SportySpots its subsidiaries, affiliates, and its licensors do
