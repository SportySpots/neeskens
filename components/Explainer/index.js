...
const Explainer = () => {
    ...
    return (
        <React.Fragment>
            <h2 className="font-sans text-center text-5xl mt-16 lg:mt-32">
            ...
            <section className="flex flex-col sm:flex-row justify-around mb-24 mt-8 lg:mt-24 lg:mb-32 pl-24 pr-24">
                <Card
                    ...
                    body={
                        'Find spots that you never knew existed in your neighbourhood.'
                    }
                ></Card>
                <Card
                    //   ref={refs[1]}
                    ...
                    body={
                        'Participate in sport activities organized around you'
                    }
                ></Card>
                <Card
                    //   ref={refs[2]}
                    ...
                    body={
                        'Easily create open or private activities. with likeminderd sporters'
                    }
                ></Card>
            </section>
        </React.Fragment>
